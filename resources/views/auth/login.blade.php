...
@csrf
      ...
      <a href="{{ route('password.request') }}" class="mt-10 text-center text-sm text-gray-500 font-semibold leading-6 text-indigo-600 hover:text-indigo-500">Forgot Password</a>
