...
<body>
    ...
    <form id="editor-form" method="POST" action="{{ route('edit.store') }}">
        <!-- CSRF Token -->
        ...
        <div class="horizontal-group" >
            ...
            <div class="form-group" id="judul">
                ...
                <select id="judul_berita" name="judul_berita">
                    @foreach ($news as $new)
                    <option value="{{ $new->judul_berita }}">  {{ $new->judul_berita }}   </option>
                    @endforeach
                </select>
            </div>         
            ...
            <div class="form-group" id="jenis">
                ...
                <input type="text" id="jenis_berita" name="jenis_berita">
            </div>
